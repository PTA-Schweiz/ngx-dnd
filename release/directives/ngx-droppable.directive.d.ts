import { OnInit, OnDestroy, AfterViewInit, ElementRef, EventEmitter, Renderer } from '@angular/core';
...
export declare class DroppableDirective implements OnInit, OnDestroy, AfterViewInit {
    ...
    defaultZone: string;
    _dropZone: string;
    constructor(el: ElementRef, renderer: Renderer, drakesService: DrakeStoreService);
    ngOnInit(): void;
